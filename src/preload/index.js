...
contextBridge.exposeInMainWorld('api', {
    ...
    cloud: {
        ...
        getSurveyQuestions: (gymId) => ipcRenderer.invoke('cloud:getSurveyQuestions', { gymId }),
        saveSurveyQuestions: (gymId, questions, templateName) => ipcRenderer.invoke('cloud:saveSurveyQuestions', { gymId, questions, templateName }),
        getSurveyAnswers: (gymId, customerLocalId, limit) => ipcRenderer.invoke('cloud:getSurveyAnswers', { gymId, customerLocalId, limit }),
        getSurveyTemplates: (gymId) => ipcRenderer.invoke('cloud:getSurveyTemplates', { gymId }),
        saveSurveyTemplate: (gymId, name, questions, localId) => ipcRenderer.invoke('cloud:saveSurveyTemplate', { gymId, name, questions, localId }),
        deleteSurveyTemplate: (gymId, localId) => ipcRenderer.invoke('cloud:deleteSurveyTemplate', { gymId, localId }),
    ...
    admin: {
        ...
        setFeatures: (gymId, features) => ipcRenderer.invoke('admin:setFeatures', { gymId, features }),
