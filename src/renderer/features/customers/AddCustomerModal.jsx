...
export default function AddCustomerModal({ isOpen, onClose, customerToEdit = null }) {
    ...
    // La marca "cliente online" solo tiene sentido si el gimnasio tiene app de
    // socios: de ella cuelga la encuesta semanal y el ocultar el horario en la app.
    const showMobileScheduleToggle = hasModule('mobile_app');
    const { t } = useLanguage();
