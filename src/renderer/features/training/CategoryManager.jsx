                                                ...
                                                <button
                                                    onClick={(e) => {
                                                        ...
                                                        setConfirmModal({
                                                            ...
                                                            children: `¿Estás seguro de eliminar la categoría "${cat.name}" y todo su contenido? Se perderán todos los ejercicios asociados.`,
                                                            type: 'danger',
                                                        ...
                                                        <button
                                                            onClick={() => {
                                                                setConfirmModal({
                                                                    ...
                                                                    children: `¿Eliminar subcategoría "${sub.name}"?`,
                                                                    type: 'danger',
                                                                    confirmText: 'Eliminar',
                                                                    onConfirm: () => deleteSubcategory.mutate(sub.id)
                                                                });
                                                            }}
